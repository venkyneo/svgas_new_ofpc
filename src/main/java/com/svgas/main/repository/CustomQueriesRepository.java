...
public interface CustomQueriesRepository 
{
	...
	List<String> getDailyReport_avg(String tablename, String pcolnames, String sdate, String edate,String timegap,List<String> tlist, String cumulativecolname,String mode_colname,String gasflow_colname);
	boolean checkList(List<String> tlist,String pcolstr);
	List<String> getMonthlyReport(String tablename,String pcolnames,String month,String year, String cumulativecolname,String mode_colname,String gasflow_colname);
